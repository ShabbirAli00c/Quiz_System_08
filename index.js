...
const Quiz = await inquirer.prompt([
    ...
    },
    {
        name: "question_4",
        type: "list",
        message: "Q4.In Typescript, which symbol is coomonly used to terminate a statement?",
        choices: [".", ":", ";", ","],
    },
    {
        name: "question_5",
        type: "list",
        message: "Q5.Which method of Inquirer.js is used to start the prompt interface and recive input?",
    ...
    },
    {
        name: "question_7",
        type: "list",
        message: "Q7.Which method is used to convert a TypeScript file to JavaScript?",
    ...
    },
    {
        name: "question_9",
        type: "list",
        message: "Q9.Which of the options below power the interactive TypeScript experience in Visual Studio, Vs Code,Sublime, the TypeScript playground and other editor.",
        choices: [
            "TypeScript main",
            "TypeScript language",
            "TypeScript compiler",
